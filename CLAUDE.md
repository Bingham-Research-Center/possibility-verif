...
- **Probabilistic lane** (§3): IG via possibility-to-probability conversion — converts to probabilities (with explicit ignorance outcome), measures information gain relative to SPC climatological baseline.
