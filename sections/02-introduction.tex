...
theoretical literature, no systematic framework has been proposed for verifying
possibilistic forecasts.  This paper proposes a framework to address
this gap.
...
distributions (Appendix~\ref{sec:ds_connections}).
...
no systematic verification framework has been proposed for subnormal
possibility distributions.  Existing approaches either normalize the distribution---
...
possibility from probability.  This paper proposes a unified framework
...
mode-based threshold scores familiar to operational meteorologists.
...
conditional necessity) independently contributes verification value, and
defines three complementary verification lanes---categorical,
probabilistic, and native possibilistic.
...
Section~\ref{sec:discussion} discusses applicability beyond severe
weather and future directions; Appendix~\ref{sec:ds_connections}
develops connections to Dempster--Shafer theory.
