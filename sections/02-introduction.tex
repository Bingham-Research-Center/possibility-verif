...
\citet{Wilks2011-MISSING}---provides the conceptual vocabulary
...
possibility-to-probability bridge that preserves ignorance as an explicit
outcome, and a categorical verification lane using threshold-based
categorical scores familiar to operational meteorologists.
...
bridge and reviews the information-gain decomposition.
